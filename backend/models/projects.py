...
class Projects(Base):
    ...
    state_en:Mapped[str | None] = mapped_column(String(50), nullable=True)
    ...
    description_en_reviewed:Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    state_en_reviewed:Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
